...
import DatabaseQueries.StudentQueries;
...
public class student extends HttpServlet {
    ...
    private StudentQueries stdQry = new StudentQueries();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       reader = read.readLine();
        ...
        try {
            ...
            switch (action){
                case "signup":
                    responseObj.put("response", stdQry.signup(username, password));
                    pWriter.print(responseObj);
                    break;
                case "signin":
                    switch(stdQry.signin(username, password)){
                        case "success":
                            responseObj.put("response", "success");
                            pWriter.print(responseObj);
